...
// Seb : On ajoute la gestion des 4 sondes de temperature DS18B20
#define TEMP_ONE_BUS 2


// Setup a oneWire instance to communicate with any OneWire devices (not just Maxim/Dallas temperature ICs)
OneWire oneWire1(TEMP_ONE_BUS);
...
/* StellarBox variables */
float Temperature1;

/*==============================================================================
 * FUNCTIONS STELLARBOX
 *============================================================================*/

void setupStellarBox(){
